  ...
  return (
    ...
    <View style={styles.home}>
      ...
      <View style={styles.content}>
        <Text style={styles.title}>Dukundane Remy</Text>
      </View>
      </TouchableOpacity>
      <TouchableOpacity style={styles.dashboard}>
      <Fontisto name="email" size={30} color="#1E5DFF" style={styles.icon} />
      <View style={styles.content}>
        <Text style={styles.title}>dukundaneremy2001@gmail.com</Text>
      </View>
       </TouchableOpacity>
       <TouchableOpacity style={styles.dashboard}>
       <Feather name="phone" size={30} color="#1E5DFF" style={styles.icon} />
      <View style={styles.content}>
        <Text style={styles.title}>+250788635342</Text>
      </View>
      ...
      <View style={styles.content}>
        <Text style={styles.title}>1997-07-25</Text>
      </View>
      ...
      <View style={styles.content}>
        <Text style={styles.title}>Nyarugenge,Kigali</Text>
      </View>
